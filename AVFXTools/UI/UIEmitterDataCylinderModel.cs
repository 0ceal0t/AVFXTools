...
namespace AVFXTools.UI
{
    public class UIEmitterDataCylinderModel : UIEmitterDataBase
    {
        ...
        public UIEmitterDataCylinderModel(AVFXEmitterDataCylinderModel data)
        {
            ...
            Length = new UICurve(Data.Length, "Length");
            InjectionSpeed = new UICurve(Data.InjectionSpeed, "Injection Speed");
        }
        ...
        public override void Draw(string id)
        {
            if (ImGui.TreeNode("Data" + id))
            {
                ...
                Length.Draw(id + "-length");
                InjectionSpeed.Draw(id + "-injectionspeed");
